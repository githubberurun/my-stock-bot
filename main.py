...
# --- 2. 銘柄フルスキャン (全3800社を最後まで見る) ---
df_all = get_latest_jpx_list()
print(f"全 {len(df_all)} 社のフルスキャンを開始します（打ち切りなし）...")
...
print(f"選抜完了。後半コードの銘柄を含む全社から上位 {len(target_list)} 社を分析します。")

# --- 3. 詳細分析 (選ばれた200社のみ深掘り) ---
final_rows = []
